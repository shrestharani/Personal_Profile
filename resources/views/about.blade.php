                ...
                <div class="about_w3l position-relative">
                    <div class="profile-wrapper">
                        <div class="profile-image">
                            <img src="assests/images/about.jpg" alt="about image" class="img-fluid" />
                        </div>
                        <h2 class="profile-title">Kondabathini <span>Shrestharani</span></h2>
                        <div class="profile-info">
                            <div class="content">
                                <p>I am an Associate Software Engineer with hands-on experience in building scalable web applications using ASP.NET Core, ASP.NET MVC, Web API, Node.js, React.js, and modern web technologies. I enjoy turning business requirements into reliable software solutions and working across backend APIs, database design, and application architecture.</p>
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <h4 class="mb-3">Current Role</h4>
                                        <ul class="list-unstyled">
                                            <li><strong>Associate Software Engineer</strong></li>
                                            <li>Casepoint Pvt. Ltd.</li>
                                            <li>Jan 2024 – March 2026</li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <h4 class="mb-3">Core Strengths</h4>
                                        <ul>
                                            <li>REST API Development</li>
                                            <li>Dependency Injection & MVC Architecture</li>
                                            <li>SQL Server, PostgreSQL, Oracle</li>
