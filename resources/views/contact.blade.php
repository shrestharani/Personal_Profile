                ...
                <div class="row py-4">
                    <div class="col-lg-5 mb-4">
                        <div class="card p-4 h-100">
                            <h4>Let's connect</h4>
                            <p>I’m open to software development opportunities, full-time roles, and freelance projects.</p>
                            <ul class="list-unstyled">
                                <li><strong>Email:</strong> your.email@example.com</li>
                                <li><strong>Location:</strong> India</li>
                                <li><strong>Focus:</strong> .NET, Node.js, APIs, and modern web apps</li>
                            </ul>
                        </div>
                    </div>
