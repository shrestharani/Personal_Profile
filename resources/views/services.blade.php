...
<body>
        ...
        <header>
            ...
            <nav id="menu" class="panel">
                <ul>
                    ...
                    <li><a href="services" class="active">Experience</a></li>
    ...
    <section class="pb-5">
        <div class="container">
            <div class="wthree-inner-sec services-bg">
                <div class="sec-head">
                    <h1 class="sec-title-w3 text-capitalize text-white">Experience</h1>
                ...
                <div class="row py-5">
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 p-4">
                            ...
                            <p><strong>Casepoint Pvt. Ltd.</strong><br>Jan 2024 – March 2026</p>
                            <ul>
                                <li>Developed and maintained web applications using ASP.NET Core, ASP.NET MVC, and PHP Laravel.</li>
                                <li>Built REST APIs for seamless frontend integration.</li>
                                <li>Worked with SQL Server, PostgreSQL, Oracle, and Entity Framework Core for data-driven features.</li>
                                <li>Applied MVC architecture, dependency injection, and clean coding practices.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-4">
                        <div class="card h-100 p-4">
                            ...
                            <ul>
                                <li>Backend development with .NET, Node.js, PHP, and PHP Laravel</li>
                                <li>Responsive web interfaces with HTML, CSS, JavaScript, and React.js</li>
                                <li>Database-driven application design with SQL and modern ORMs</li>
                                <li>API development and cloud basics on Azure</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <footer>
        <div class="cpy-right text-center py-4">
            <p class="text-white">© 2026 Kondabathini Shrestharani</p>
        </div>
    </footer>
