...
<body>
        ...
        <div class="container">
            <div class="wthree-inner-sec skills-bg">
                <div class="sec-head text-center">
                    <h1 class="sec-title-w3 text-capitalize text-dark">Skills & Technologies</h1>
                ...
                <div class="row py-5">
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 p-4">
                            ...
                            <p>ASP.NET Core, ASP.NET MVC, Web API, C++, Java, Python, Node.js, React.js, Kendo UI, PHP, PHP Laravel</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 p-4">
                            <h4>Programming Languages</h4>
                            <p>C#, JavaScript, HTML, CSS, SQL, PHP</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 p-4">
                            <h4>Databases & ORMs</h4>
                            <p>SQL Server, RDBMS, PostgreSQL, Oracle, Entity Framework Core</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="card h-100 p-4">
                            <h4>Concepts & Tools</h4>
                            <p>REST API Development, Dependency Injection, MVC Architecture, Git, Microsoft Azure basics</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="assests/js/skill.js"></script>
